...
* Outcomes: selected adverse events of special interest; negative control outcomes; imputed positive control outcomes
* Analyses: 
...
ncs <- readr::read_csv(system.file("settings", "NegativeControlOutcomes.csv", package = "Eumaeus"), col_types = readr::cols())
